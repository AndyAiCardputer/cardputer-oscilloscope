...
const uint16_t waveColors[] = { COL_GREEN, COL_CYAN, COL_YELLOW, COL_ORANGE };

// --- Waveform Table ---
#define WAVE_TABLE_SIZE 64
#define WAVE_PWM_FREQ   40000
#define WAVE_PWM_BITS   8
...
void setup() {
    ...
    // Release Grove pins for signal output
...
void drawUI() {
    ...
    canvas.print("R:on/off  A:reset  1-9:preset  [ADV]");
}
