...
int actualFreq = 1000;      // real output frequency (may differ for non-square)
int presetIdx = 9;
int dutyPercent = 50;
bool outputOn = true;
int ledcBits = 10;
