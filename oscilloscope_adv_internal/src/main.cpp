/*
 * Pocket Oscilloscope ADV (Internal Display)
 * Version: 2.0.0
 *
 * Single-channel oscilloscope with DMA-accelerated ADC sampling.
 * For M5Stack Cardputer ADV with internal 240x135 display.
...
// --- DMA ADC ---
#define DMA_MAX_RATE      83333
#define DMA_MIN_RATE      611
#define DMA_FRAME_SIZE    256
#define DMA_RESULT_BYTES  4
...
void setup() {
    Serial.begin(115200);
    delay(300);
    Serial.println("\n=== Pocket Oscilloscope ADV v2.0.0 ===");
    ...
    Serial.println("M5Cardputer ADV initialized");

    canvas.createSprite(SCREEN_W, SCREEN_H);
    canvas.setTextSize(1);

    // Release Grove pins for ADC/signal use
    // Do NOT delete I2C drivers -- ADV keyboard TCA8418 needs I2C on GPIO 8/9
...
void drawStatusBar() {
    ...
    canvas.setTextColor(COL_TEXT_DIM);
    canvas.setCursor(0, y);
    canvas.print("R ;.T +-V A:auto C:cal G:sig [ADV]");
}
